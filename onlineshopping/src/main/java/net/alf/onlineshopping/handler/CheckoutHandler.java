package net.alf.onlineshopping.handler;
...
import net.alf.onlineshopping.model.CheckoutModel;
import net.alf.onlineshopping.model.UserModel;
import net.alf.shoppingbackend.dao.CartLineDAO;
import net.alf.shoppingbackend.dao.ProductDAO;
import net.alf.shoppingbackend.dao.UserDAO;
import net.alf.shoppingbackend.dto.Address;
import net.alf.shoppingbackend.dto.Cart;
import net.alf.shoppingbackend.dto.CartLine;
import net.alf.shoppingbackend.dto.OrderDetail;
import net.alf.shoppingbackend.dto.OrderItem;
import net.alf.shoppingbackend.dto.Product;
